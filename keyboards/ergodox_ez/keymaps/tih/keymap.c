 ...
 * |        |   Ч  |   В  |   Е  |   Р  |   Т  |      |           |      |   Ц  |   У  |   Ы  |   О  |   П  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   Ctl  |   А  |   С  |   Д  |   Ф  |   Г  |------|           |------|   Х  |   Й  |   К  |   Л  |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   З  |   Ж  |   Ш  |   Щ  |   Б  |      |           |      |   Н  |   М  |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      | Super|  Alt |   Ъ  | Soft |                                       | Soft |   Ь  | Alt  | Super|      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
[TONO] = LAYOUT_ergodox(
  ...
  KC_LCTL, ALPT,    _______, _______, _______, _______,
  _______, _______, _______, _______, OMET,    _______, _______,
  _______, KC_LGUI, KC_LALT, _______, _______,
                                               _______, _______,
                                                        _______,
                                     _______,  _______, _______,
  // right hand
  ...
  _______, _______, _______, _______, _______, _______, _______,
                    _______, _______, KC_ALGR, KC_RGUI, _______,
  _______, _______,
  _______,
  _______, _______, _______
),
...
[NUMS] = LAYOUT_ergodox(
  ...
  _______, _______, _______, _______, _______, _______,
  _______, KC_ESC,  KC_TAB,  KC_GRV,  KC_EQL,  KC_CAPS, _______,
  _______, _______, _______, _______, _______,
                                               _______, _______,
                                                        _______,
                                      _______, _______, _______,
 ...
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 * | Version |  F1  |  F2  |  F3  |  F4  |  F5  |Loader|           |Reset |  F6  |  F7  |  F8  |  F9  | F10  |  F11   |
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * |         |   1  |   2  |   3  |   4  |   5  |      |           |      |   6  |   7  |   8  |   9  |   0  |  F12   |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[NAVI] = LAYOUT_ergodox(
  // left hand
  VRSN,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   QK_BOOT,
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,
  ...
  // right hand
  QK_RBT,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (record->event.pressed) {
    ...
    case UPSD:
      if (keyboard_report->mods & MOD_MASK_SHIFT)
	send_unicode_string(greek_accents[(keycode-ALPT)*2]);
      else
	send_unicode_string(greek_accents[(keycode-ALPT)*2+1]);
      clear_oneshot_layer_state(ONESHOT_PRESSED);
      oneshots--;
      return false;
    case KC_LSFT:
