 ...
 * |        |   ;  |   ς  |   Ε  |   Ρ  |   Τ  |      |           |      |   Υ  |   Θ  |   Ι  |   Ο  |   Π  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   Α  |   Σ  |   Δ  |   Φ  |   Γ  |------|           |------|   Η  |   Ξ  |   Κ  |   Λ  | hack |        | hack: put ´ and ¨ here, but as
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------| one-shot jumps to yet another
 * |        |   Ζ  |   Χ  |   Ψ  |   Ω  |   Β  |      |           |      |   Ν  |   Μ  |      |      |      |        | layer, to get the accented chars.
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[GREK] = LAYOUT_ergodox(
  // left hand
  _______, _______,      _______, _______, _______, _______, _______,
  _______, KC_SCLN,      LFSIG,   EPSILON, RHO,     TAU,     _______,
  ...
  _______, NU,           MU,      _______, _______, _______, _______,
                         _______, _______, _______, _______, _______,
  _______, _______,
  _______,
  _______, _______, _______
